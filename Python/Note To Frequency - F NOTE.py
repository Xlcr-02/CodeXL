...
notes from F0 to F8. While this could be done by adding many additional cases to your if statement, such a solution is
...
above. Then divide the frequency by 2 power(4-x ), where x is the octave number entered by the user. 
